...
import { closeReviewModal } from "../redux/modal/reviewSlice";
import { openSignModal } from "../redux/modal/signSlice";
...
const ReviewModal = () => {
  const isOpen = useSelector((state) => state.reviewModal.isOpen);
              ...
              <Box sx={style}>
                ...
                <label className="mt-4 flex items-start gap-2 cursor-pointer">
                  ...
                  <span className="text-left text-[14px] text-[#232323]">
                    I confirm that I have reviewed this document and approve its
                    submission. **
                  </span>
                </label>
                ...
                <button
                  ...
                  className={`font-semibold text-base text-white py-2 px-4 rounded-md mt-6 w-full ${
                    checked
                      ? "bg-[#00584E]"
                      : "bg-[#00584E4D] cursor-not-allowed"
                  }`}
                  onClick={() => {
