...
import docAllImg from "../assets/imgs/doc-all.png";
  ...
  return (
    <div className="w-full mx-auto mt-10">
      ...
      {files.length === 0 && (
        <div
          onClick={handleClick}
          className="border border-[#BFBFBF] bg-white rounded-lg md:p-10 p-2 text-center cursor-pointer"
        >
      ...
      {/* Uploaded Files */}
      {files.length > 0 && (
        <div className="flex-wrap border border-[#BFBFBF] bg-white rounded-lg p-4 flex gap-4 overflow-x-auto">
